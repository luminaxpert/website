      ...
      <section className="py-[80px]">
        <div className="container mx-auto px-5 max-w-[800px]">
          <div className="font-inter text-[#4A5568] text-[16px] leading-[1.8] flex flex-col gap-6">
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">1. Scope of Services</h2>
            <p>
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">2. Intellectual Property</h2>
            <p>
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">3. Confidentiality</h2>
            <p>
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">4. Limitation of Liability</h2>
            <p>
            ...
            <p className="mt-8 font-space-mono text-[12px] text-[#718096]">
