      ...
      <section className="py-[80px]">
        <div className="container mx-auto px-5 max-w-[800px]">
          <div className="font-inter text-[#4A5568] text-[16px] leading-[1.8] flex flex-col gap-6">
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">1. Information We Collect</h2>
            <p>
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">2. How We Use Your Information</h2>
            <p>
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">3. Data Security & AI Models</h2>
            <p>
            ...
            <h2 className="font-plus-jakarta-sans font-bold text-[28px] text-[#0D0D1F] mt-8 mb-2">4. Contact Us</h2>
            <p>
