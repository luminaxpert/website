...
export default function BlogPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      {/* HEADER */}
      <section className="pt-[160px] pb-[80px] bg-transparent border-b border-[var(--color-border-subtle)] relative overflow-hidden">
        ...
        <div className="container mx-auto px-5 md:px-20 max-w-[1280px] relative z-10 flex flex-col md:flex-row justify-between items-end gap-10">
          <div className="w-full md:w-2/3">
            <ScrollReveal>
              <h1 className="font-syncopate font-bold text-[40px] md:text-[64px] leading-[1.05] tracking-tight mb-6 text-white">
                Insights & <span className="text-gradient">Intelligence</span>
              </h1>
            </ScrollReveal>
            <ScrollReveal delay={0.1}>
              <p className="font-outfit text-[19px] text-[#9494c0] max-w-[500px]">
          ...
          <div className="w-full md:w-1/3 flex justify-end">
            <ScrollReveal delay={0.2} className="w-full">
              <div className="relative w-full max-w-[320px] ml-auto">
                ...
                />
                <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-[#9494c0] z-[101]" size={18} />
              </div>
            </ScrollReveal>
          </div>
        </div>
      ...
      <section className="py-[80px] bg-transparent">
        <div className="container mx-auto px-5 md:px-20 max-w-[1280px]">
          ...
          <ScrollReveal delay={0.1}>
            <div className="glass-card p-0 overflow-hidden flex flex-col md:flex-row group cursor-pointer hover:scale-[1.01] hover:shadow-[0_0_40px_rgba(224,64,251,0.15)] hover:border-[#E040FB]/40 transition-all duration-500 hover:bg-[#17173a]/80">
              <div className="w-full md:w-[55%] relative min-h-[300px] md:min-h-[400px] bg-[#0d0d1f] overflow-hidden">
              ...
              <div className="w-full md:w-[45%] p-8 md:p-12 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-outfit text-[#4a4a80] text-[13px]">Oct 18, 2026</span>
                </div>
                
                <h3 className="font-syncopate font-bold text-[24px] md:text-[28px] text-white leading-[1.3] mb-4 group-hover:text-[#E040FB] transition-colors">
                  The Composable AI Enterprise: Building Modular Intelligence
                </h3>
                
                <p className="font-outfit text-[#9494c0] text-[16px] leading-[1.6] mb-8 group-hover:text-[#b4b4d0] transition-colors">
                ...
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <div>
                    <div className="font-plus-jakarta-sans font-bold text-[14px] text-white">Faizan Ahmed</div>
                    <div className="font-space-mono text-[11px] text-[#4a4a80]">CTO, LuminaXpert</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <ScrollReveal>
            <div className="flex gap-4 mb-10 overflow-x-auto pb-4 no-scrollbar relative z-[100]">
              <button 
                ...
                className={`px-5 py-2 rounded-full font-plus-jakarta-sans text-[14px] transition-all duration-300 cursor-pointer ${filter === "All Topics" ? "glass-brand text-white shadow-[0_0_15px_rgba(224,64,251,0.3)]" : "border border-white/10 text-[#9494c0] hover:text-white hover:border-white/30 hover:bg-white/5"}`}>
                All Topics
              </button>
              {["Strategy", "Engineering", "Data", "Compliance", "Ethics & Ops", "Future Trends"].map((tag) => (
                <button 
                  ...
                  className={`px-5 py-2 rounded-full font-plus-jakarta-sans text-[14px] whitespace-nowrap transition-all duration-300 cursor-pointer ${filter === tag ? "glass-brand text-white shadow-[0_0_15px_rgba(224,64,251,0.3)]" : "border border-white/10 text-[#9494c0] hover:text-white hover:border-white/30 hover:bg-white/5"}`}>
                  {tag}
                </button>
              ))}
            </div>
              ...
              <ScrollReveal key={i} delay={i * 0.1}>
                <Link href={`/blog/${post.slug}`} className="glass-card p-0 overflow-hidden h-full group flex flex-col hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(0,217,255,0.15)] hover:border-[#00D9FF]/40 hover:bg-[#1a1a3a]/80 transition-all duration-500">
                  <div className="w-full h-[200px] overflow-hidden relative border-b border-white/5">
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0d0d1f] to-transparent z-10"></div>
                    <img src={post.image} alt={post.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                    <span className="absolute top-4 left-4 z-20 flex items-center gap-1.5 text-white bg-[#00D9FF]/80 backdrop-blur-md px-3 py-1 rounded-full font-space-mono text-[10px] uppercase tracking-wider group-hover:bg-[#E040FB]/80 transition-colors">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="font-outfit text-[#4a4a80] text-[12px]">{post.readTime}</span>
                    </div>
                    
                    <h3 className="font-syncopate font-bold text-[18px] text-white leading-[1.4] mb-3 group-hover:text-[#00D9FF] transition-colors">
                      {post.title}
                    </h3>
                    
                    <p className="font-outfit text-[#9494c0] text-[15px] leading-[1.6] mb-6 flex-1 group-hover:text-[#b4b4d0] transition-colors">
                      {post.excerpt}
                    </p>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5 group-hover:border-white/10 transition-colors">
                      <div className="flex items-center gap-2">
                         <span className="font-space-mono text-[11px] text-[#9494c0] bg-white/5 px-3 py-1.5 rounded-lg group-hover:bg-[#E040FB]/10 group-hover:text-white transition-colors">{post.author}</span>
                      </div>
                      <span className="text-white group-hover:text-[#00D9FF] transition-colors group-hover:translate-x-1 transform duration-300">
                        <ArrowRight size={18} />
                      </span>
                    </div>
                  </div>
